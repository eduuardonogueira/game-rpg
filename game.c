...
void aceitar_pacto() {
	...
	opcoes = "\t\t #O que Aphelios deverá fazer? \n"
...
int contexto() {
	char* descricao = "\t No Reino místico de Iônia, \n"
					  ...
					  "\t antigos e poderes mágicos.";
    
    // Descrição
    if (continuar(descricao) == 1) {
    	char* personagens = "\t #Personagens: \n\n"
							"\t - Aphelios (Classe: Caçador): O herói principal da narrativa, um caçador \n"
							"\t de habilidades notáveis que almeja uma vida tranquila com Liora. \n"
							...
							"\t - Veigar (Classe: Mago): Um personagem misterioso cujos segredos detêm \n"
							"\t uma influência significativa no destino de Iônia e seu mundo alternativo. \n"
							"\t - Jax (Classe: Caçador, Amigo de Aphelios): Um leal amigo \n"
							"\t de longa data conhecido por suas habilidades em combate.";
							
 		// Personagens
    	if (continuar(personagens) == 1) {
    		char* cenario = "\t #Cenário: \n\n"
							"\t O jogo se desenrola em meio às paisagens exuberantes do Reino de Iônia, \n"
							"\t bem como em um mundo alternativo dele repleto de mistérios e magia.";
    		
    		// Cenário
    		if (continuar(cenario) == 1) {
    			char * sobre = "\t #História: \n\n"
							   "\t Aphelios, um caçador aclamado que desfrutou de sucesso na cidade de Targus, \n"
							   ...
							   "\t tranquila ao lado dela no Reino de Iônia, afastando-se dos perigos do mundo exterior. \n"
							   "\t No entanto, conforme a história se desenrola, Aphelios, insatisfeito com a rotina \n"
							   "\t monótona, é arrastado para uma situação dramática com um mago chamado Veigar, \n"
							   "\t que mudará o curso de sua vida e o destino de Iônia. Esta narrativa explora \n"
							   "\t o desenvolvimento da história de Aphelios em meio a um mundo alternativo, \n"
							   "\t que o fará redescobrir sua coragem em um mundo repleto de segredos, \n"
							   "\t desafios e forças sombrias que ameaçavam o Reino e seu eterno amor por Liora.";
